> **Historical.** This is the punch list / plan from the 2026-08-20 rollout, kept for context. Every item in it has since been done; the current state is `pnpm gate` (37/37) and the tests. Do not work from this file.
